...
import 'package:dating_app/features/user/applications/profile/profile_provider.dart';
import 'package:dating_app/features/user/models/profile/profile_item.dart';
import 'package:dating_app/l10n/l10n.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class ProfileItemList extends ConsumerWidget {
        ...
        (i, profileItem) {
          return InkWell(
            onTap: () => ref
                ...
                .func(context: context, profileItem: profileItem),
            child: Container(
